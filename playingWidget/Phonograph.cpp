...
Phonograph::Phonograph(QWidget* parent):QWidget(parent),
    ...
    currentArmAngle(0),
    playing(false),
    AlbumCover(":/playingwidget/images/playingwidget/AlbumCover1.jpg"),
    disk(":/playingwidget/images/playingwidget/netease_disk.png"),
    toneArm(":/playingwidget/images/playingwidget/netease_tone_arm.png")
{
...
void Phonograph::initPaintingData(bool firstTime)
{
   if(firstTime)
   {
        albumWidth = 400 * ScaleUtil::scale();
        albumHeight = 400 * ScaleUtil::scale();
        toneArmWidth = 200 * ScaleUtil::scale();
        toneArmHeight = 100 * ScaleUtil::scale();
