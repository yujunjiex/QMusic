...
public:
    ...
    int getHeigth()
    {
        int height = 300* ScaleUtil::scale();
...
protected:
    virtual void paintEvent(QPaintEvent *e)
    {
        ...
        QFont font;
        font.setPointSize(ScaleUtil::fontSizeScale(10));
        font.setWeight(ScaleUtil::fontSizeScale(61));
        ...
        for(int i = 0; i< lrcLyrics.size();i++)
        {
            ...
            int height = 30;
            if(rec.width() > 490* ScaleUtil::scale())
                height += 30;

            QRectF lineRect;
            lineRect.setRect(2, (i) * 45,
                             496* ScaleUtil::scale(),height* ScaleUtil::scale());
...
public:
    ScrollLyricPanel(QWidget* parent):QWidget(parent)
    {
        ...
        lyricPanel->setMinimumWidth(500* ScaleUtil::scale());
...
public slots:
    ...
    void setMusicAlbum(QString album);
    void setMusicSinger(QString singer);
...
public:
    ...
    QLabel                    *labelPreviewAlbumTip;
    QLabel                    *labelPreviewSingerTip;

    QLabel                    *labelPreviewAlbum;
    QLabel                    *labelPreviewSinger;
